...
import { SearchProjectsForUserServiceInterface } from '../interfaces/search-projects-for-user-service.interface';

@Injectable()
export class SearchProjectsForUserService implements SearchProjectsForUserServiceInterface {
  constructor(
